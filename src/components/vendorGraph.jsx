                      ...
                      <CountUp
                        start={
                          ((topCardsH.PCS_IN_ALTERATION +
                            topCardsH.ALTERED_PIECES.value) *
                            100) /
                ...
                <Grid container>
                  ...
                  <Grid item xs={10}>
                    {topCards.NO_OF_DEFECTS.value != null ? (
                      <CountUp
                        start={
                          (topCardsH.NO_OF_DEFECTS.value * 100) /
                          topCardsH.NO_OF_PCS
                        }
                        end={
                          (topCards.NO_OF_DEFECTS.value * 100) /
                          topCards.NO_OF_PCS
                        }
                        duration={0.6}
                        separator={","}
                ...
                <Grid container>
                  ...
                  <Grid item xs={10}>
                    {topCards.REJECTED_PIECES != null ? (
                      <CountUp
                        start={
                          (topCardsH.REJECTED_PIECES.value * 100) /
                          topCardsH.NO_OF_PCS
                        }
                        end={
                          (topCards.REJECTED_PIECES.value * 100) /
                          topCards.NO_OF_PCS
                        }
                        duration={0.6}
                        separator={","}
                ...
                <Grid container>
                  <Grid item xs={3}>
                    {topCards.ACTIVE_LOCATIONS != null ? (
                      ...
                      >
                        <CountUp
                          start={topCardsH.ACTIVE_LOCATIONS}
                          end={topCards.ACTIVE_LOCATIONS}
                          duration={0.6}
                          separator={","}
                  ...
                  <Grid item xs={3}>
                    {topCards.INACTIVE_LOCATIONS != null ? (
                      ...
                      >
                        <CountUp
                          start={topCardsH.INACTIVE_LOCATIONS}
                          end={topCards.INACTIVE_LOCATIONS}
                          duration={0.6}
                          separator={","}
                          className={classes.topRightCG}
                        />
