...
export default function VendorGraph(props) {
    ...
    useEffect(() => {
        ...
        switch (age) {
            case "":
                temp = lineGraph.producedPieces;
                break;
            case "Ok":
                temp = lineGraph.okPieces;
                break;
            case "Alter":
                temp = lineGraph.alteredPieces;
                break;
            case "Rejected":
                temp = lineGraph.rejectedPieces;
                break;
            case "DHU":
                temp = lineGraph.dhu;
                break;
                ...
                <Grid item xs={4}>
                    <Grid container justifyContent="center" spacing={"1"}>
                        <Grid item xs={6} align="center">
                            <div
                                className={classes.cardG}
                                data-tip
                                data-for={"Pcs-Produced"}
                            >
                                <Grid container>
                                    <Grid item xs={10}>
                                        <Typography
                                            className={classes.labelHeaderG}
                                        >
                                            {"Pcs Produced"}
                                        </Typography>
                                    </Grid>
                        ...
                        <Grid item xs={6} align="center">
                            ...
                            >
                                <Grid container>
                                    <Grid item xs={10}>
                                        <Typography
                                            className={classes.labelHeaderB}
                                        >
                                            {"OK Pieces"}
                                        </Typography>
                                    </Grid>
                        ...
                        <Grid item xs={6} align="center">
                            <div
                                className={classes.cardY}
                                data-tip
                                data-for={"Rectified-Pcs"}
                            >
                                <Grid container>
                                    <Grid item xs={8}>
                                        <Typography
                                            className={classes.labelHeaderY}
                                        >
                                            {"Rectified Pcs"}
                                        </Typography>
                                    </Grid>
                                ...
                                <Grid container>
                                    <Grid item xs={4}></Grid>
                                    <Grid item xs={8}>
                                        {topCards.ALTERED_PIECES.value !=
                                        null ? (
                                            <CountUp
                                                start={
                                                    topCardsH.ALTERED_PIECES
                                                        .value
                                                }
                                                end={
                                                    topCards.ALTERED_PIECES
                                                        .value
                                                }
                                                duration={0.6}
                                                separator={","}
                            ...
                            {topCards.ALTERED_PIECES.tooltip != null ? (
                                <ReactTooltip
                                    ...
                                    backgroundColor={"#fffce6"}
                                >
                                    {topCards.ALTERED_PIECES.tooltip
                                        .slice(0, 10)
                                        .map((item) => (
                                            <Grid container>
                                                <Grid item xs={10}>
                        ...
                        <Grid item xs={6} align="center">
                            <div
                                className={classes.cardR}
                                data-tip
                                data-for={"Rejected-Pcs"}
                            >
                                <Grid container>
                                    <Grid item xs={8}>
                                        <Typography
                                            className={classes.labelHeaderR}
                                        >
                                            {"Rejected Pcs"}
                                        </Typography>
                                    </Grid>
                                ...
                                <Grid container>
                                    <Grid item xs={4}></Grid>
                                    <Grid item xs={8}>
                                        {topCards.REJECTED_PIECES.value !=
                                        null ? (
                                            <CountUp
                                                start={
                                                    topCardsH.REJECTED_PIECES
                                                        .value
                                                }
                                                end={
                                                    topCards.REJECTED_PIECES
                                                        .value
                                                }
                                                duration={0.6}
                                                separator={","}
                            ...
                            {topCards.REJECTED_PIECES.tooltip != null ? (
                                <ReactTooltip
                                    ...
                                    backgroundColor={"#fff0f5"}
                                >
                                    {topCards.REJECTED_PIECES.tooltip
                                        .slice(0, 10)
                                        .map((item) => (
                                            <Grid container>
                                                <Grid item xs={10}>
                        ...
                        <Grid item xs={4} align="center">
                            ...
                            >
                                <Grid container>
                                    <Grid item xs={11}>
                                        <Typography
                                            className={classes.labelHeaderYX}
                                        >
                                            {"Rework %"}
                                        </Typography>
                                    </Grid>
                                ...
                                <Grid container>
                                    ...
                                    <Grid item xs={10}>
                                        ...
                                        null ? (
                                            <CountUp
                                                start={
                                                    ((topCardsH.PCS_IN_ALTERATION +
                                                        topCardsH.ALTERED_PIECES
                                                            .value) *
                                                        100) /
                                                    topCardsH.TOT_PCS.value
                                                }
                                                end={
                                                    ((topCards.PCS_IN_ALTERATION +
                                                        topCards.ALTERED_PIECES
                                                            .value) *
                                                        100) /
                                                    topCards.TOT_PCS.value
                                                }
                                                duration={0.6}
                                                separator={","}
                                                decimals={2}
                            ...
                            {topCards.REJECTED_PIECES.defects != null ? (
                                <ReactTooltip
                                    ...
                                    backgroundColor={"#fff0f5"}
                                >
                                    {topCards.REJECTED_PIECES.defects
                                        .slice(0, 10)
                                        .map((item) => (
                                            <Grid container>
                                                <Grid item xs={10}>
                        ...
                        <Grid item xs={4} align="center">
                            ...
                            >
                                <Grid container>
                                    <Grid item xs={8}>
                                        <Typography
                                            className={classes.labelHeaderO}
                                        >
                                            {"DHU %"}
                                        </Typography>
                                    </Grid>
                                ...
                                <Grid container>
                                    ...
                                    <Grid item xs={10}>
                                        ...
                                        null ? (
                                            <CountUp
                                                start={
                                                    (topCardsH.NO_OF_DEFECTS
                                                        .value *
                                                        100) /
                                                    topCardsH.NO_OF_PCS
                                                }
                                                end={
                                                    (topCards.NO_OF_DEFECTS
                                                        .value *
                                                        100) /
                                                    topCards.NO_OF_PCS
                                                }
                            ...
                            {topCards.NO_OF_DEFECTS.tooltip != null ? (
                                <ReactTooltip
                                    ...
                                    backgroundColor={"#fffce6"}
                                >
                                    {topCards.NO_OF_DEFECTS.tooltip
                                        .slice(0, 10)
                                        .map((item) => (
                                            <Grid container>
                                                <Grid item xs={10}>
                ...
                >
                    ...
                    >
                        <Select
                            ...
                            // }
                        >
                            <MenuItem value="">Pcs Produced</MenuItem>
                        ...
                        >
                            <div className={classes.cardCB}>
                                <Grid container>
                                    <Grid item xs={3}>
                                        <Typography
                                            className={classes.labelHeaderCB}
                                        >
                                            {"Audits"}
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={3}>
                                        <Typography
                                            className={classes.labelHeaderCBX}
                                        >
                                            {"Total"}
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={3}>
                                        <Typography
                                            className={classes.labelHeaderGX}
                                        >
                                            {"Pass"}
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={3}>
                                        <Typography
                                            className={classes.labelHeaderRX}
                                        >
                                            {"Fail"}
                                        </Typography>
                                    </Grid>
                                    ...
                                    <Grid item xs={3}>
                                        {topCards.AUDITS_DONE.value != null ? (
                                            ...
                                            >
                                                <CountUp
                                                    start={
                                                        topCardsH.AUDITS_DONE
                                                            .value
                                                    }
                                                    end={
                                                        topCards.AUDITS_DONE
                                                            .value
                                                    }
                                                    duration={0.6}
                                                    separator={","}
                                    ...
                                    <Grid item xs={3}>
                                        {topCards.INACTIVE_LINES != null ? (
                                            ...
                                            >
                                                <CountUp
                                                    start={
                                                        topCardsH.INACTIVE_LINES
                                                    }
                                                    end={
                                                        topCards.INACTIVE_LINES
                                                    }
                                                    duration={0.6}
                                                    separator={","}
                                                    className={
