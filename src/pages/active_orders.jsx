...
const ActiveOrders = (props) => {
  ...
  // useEffect(() => {
  //   if (comparisonData != null && activeOrderData != null) {
  //     activeOrderData.forEach((element, index) => {
  //       element["comparisons"] = comparisonData[index];
  //     });
  //   }
  //   console.log(activeOrderData);
  // }, [activeOrderData, comparisonData]);
  ...
  var filteredData = activeOrderData.filter(
    (data) =>
  ...
  const handleQtyLimitsChangeLower = (event) => {
    ...
    if (event.target.value == "") {
      ...
      if (isNaN(event.target.value)) {
        ...
        setQtyLower(parseInt(event.target.value));
      }
    }
  };
  ...
  if (activeOrderData.length == 0 && loggedIn) {
    if (noRecords) {
      return (
        <div>
          <header>
            <TopBar page="active_orders" />
          </header>
    ...
    return (
      <div className="hello">
            ...
            <Grid container item xs={4}>
              ...
              <Grid container spacing={1} item xs={12}>
                <Grid align="center" item xs={4}>
                  ...
                  >
                    <Typography className={classes.statusbtn}>Both</Typography>
                  </Button>
                </Grid>
                <Grid align="center" item xs={4}>
                  <Button
                  ...
                  >
                    <Typography className={classes.statusbtn}>Fail</Typography>
                  </Button>
                </Grid>
                <Grid align="center" item xs={4}>
                  <Button
                  ...
                  >
                    <Typography className={classes.statusbtn}>Pass</Typography>
                  </Button>
                </Grid>
                <Grid item xs={4}></Grid>
              </Grid>
        ...
        />
        {showFilter ? (
          <ResetFloating page="active-orders" handleClick={handleReset} />
        ) : null}
      </div>
    );
  } else {
